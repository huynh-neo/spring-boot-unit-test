...
public class StudentAndGradeServiceTest {
    ...
    public void createStudentService() {
        ...
        assertEquals("chad.darby@code_school.com", student.getEmailAddress(), "find by email");
    }
    ...
    public void studentInformationService() {
        ...
        assertEquals("eric.roby@code_school.com", gradebookCollegeStudentTest.getEmailAddress());
